...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "ldCUDjDj40TKvG8BoKAySTbv";
    public static String secretKey = "6ixwh1M3qjQ6DiXlfycPlCeCPD1n8hai";
    public static String licenseID = "zzaswms-face-android";
     ...
     */
    public static String groupID = "zzasGroup";
