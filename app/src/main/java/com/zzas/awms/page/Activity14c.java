...
public class Activity14c extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private wmsamAnQuanaBean.outData checkrecorda;
    private wmsamAnQuanbBean.outData checkrecordb;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        XUI.initTheme(this);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_14c);
        //按钮
        ...
        //页面传值
        checkrecorda = (wmsamAnQuanaBean.outData) getIntent().getSerializableExtra("checkrecorda");
        checkrecordb = (wmsamAnQuanbBean.outData) getIntent().getSerializableExtra("checkrecordb");
        SetPageShowFun();
    }
    //初始化页面显示
    ...
    //执行设备巡检确认请求接口
    protected void UpdateAnQuanData(String setdata){
        ...
        rxjavaService .postMapAnQuanUpdate(body)
