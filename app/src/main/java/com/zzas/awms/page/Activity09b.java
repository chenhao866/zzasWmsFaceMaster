...
public class Activity09b extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_09b);
        //TextView
    ...
    private void DialogFun(String str, String tag){
        ...
        zzasdialog.showSimpleTipDialog(Activity09b.this,str,tag,YesClick);
    }
    //弹窗确定按钮点击事件
