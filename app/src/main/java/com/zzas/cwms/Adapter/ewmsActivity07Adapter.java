...
public class ewmsActivity07Adapter extends BaseAdapter {

    private List<ewmsActivity07Model> mData;
    private Context mContext;

    public ewmsActivity07Adapter  (Context context,List data){
        this.mData = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view =null;
        ewmsActivity07Adapter.Holder holder = null;
        if(convertView != null){
            view = convertView;
            holder = (ewmsActivity07Adapter.Holder)view.getTag();
        }else{
            view = View.inflate(mContext, R.layout.activity_04item, null);
            holder = new ewmsActivity07Adapter.Holder();
        ...
        ewmsActivity07Model  friend = mData.get(position);
